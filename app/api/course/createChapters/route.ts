...
export async function POST(req: Request) {
  try {
    ...
    console.log("image search term", JSON.stringify(imageSearchTerm), "\n");
    console.log("output units", JSON.stringify(output_units), "\n");
    ...
    return new NextResponse("internal server error in creating course", {
      status: 500,
    });
  }
}
